#!/bin/bash
# Installs MemeGen for Azure, modified to be used in a ARM Templates

# Print each command and exit as soon as something fails.
set -ex

YOURID="TODO probably have to get this from an instance metadata call, substringing a resource name or something, we cannot get this from the arm template because of json restrictions, yay."
CLOUD="AZ"
